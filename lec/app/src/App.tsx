    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-content flex-1 px-4 py-6 md:py-8">
        {view === 'roster2027' ? (
          ...
          <>
            <FilterBar state={state} update={update} matchCount={matchCount} total={players.length} />
      ...
      {selectedPlayer && <PlayerDrawer player={selectedPlayer} onClose={() => setSelectedPlayerId(null)} />}
    </div>
  );
}
